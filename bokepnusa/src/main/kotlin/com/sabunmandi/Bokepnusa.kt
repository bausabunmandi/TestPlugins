    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val items =
                document.select(".site-main article").mapNotNull { article ->
                    ...
                    val title =
                            article.selectFirst(".post-thumbnail-container img")?.attr("alt")
                                    ?: "No Title"
                    val poster =
                            article.selectFirst(".post-thumbnail-container img")?.attr("data-src")
                                    ?: article.selectFirst(".post-thumbnail-container img")
                                            ?.attr("src")
