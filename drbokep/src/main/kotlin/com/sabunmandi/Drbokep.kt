...
class Drbokep : MainAPI() {
    ...
    //         // This regex will match any URL starting with http or https that ends with .m3u8 and
    ...
    //         val masterUrl =
    // resolveRedirects("https://fem.pemersatu.link/${urlCandidates.first()}")

    //         val typeVideo = when { masterUrl.contains(".mp4") -> ExtractorLinkType.VIDEO else  ->
